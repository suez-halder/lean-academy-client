        ...
        <div>
            ...
            <div className="mt-12">
                <div className="w-3/4 mx-auto flex">
                    <img src="https://i.ibb.co/rfvGnck/ivana.png" className="w-1/6 mx-auto rounded-full shadow-2xl" />
                    <div className="ml-8">
                ...
                <div className="w-3/4 mx-auto flex">
                    <img src="https://i.ibb.co/xJPDsrj/user-1.png" className="w-1/6 mx-auto rounded-full shadow-2xl" />
                    <div className="ml-8">
                        ...
                        <h1 className="text-2xl font-bold mb-2">Pauly Garita</h1>
